...
public abstract class FragmentAccompanimentMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected AccompanimentMenuFragment mContext;
  ...
  public abstract void setContext(@Nullable AccompanimentMenuFragment context);

  @Nullable
  public AccompanimentMenuFragment getContext() {
    return mContext;
  }
